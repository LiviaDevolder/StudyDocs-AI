...
export default function ProjectDocumentsScreen() {
  ...
  return (
    <Box flex={1} safeArea bg={colorScheme === 'dark' ? 'gray.900' : 'white'}>
      ...
      <Box flex={1} px={6}>
        <Center flex={1}>
          <Icon as={Ionicons} name="documents-outline" size="4xl" color={colorScheme === 'dark' ? 'gray.700' : 'gray.300'} mb={4} />
          ...
          <Text color={colorScheme === 'dark' ? 'gray.500' : 'gray.500'} fontSize="sm" textAlign="center" px={8}>
            Em breve você poderá fazer upload ou escanear documentos para este projeto
          </Text>
        </Center>
      </Box>
    </Box>
